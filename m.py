...
API_TOKEN = '8098106721:AAEwDt98qHNJNNtWyQXxu95DTguiTBzVKj4'
...
async def add_user(message: Message):
    if message.from_user.id!= ADMIN_ID:
        await message.answer("You're not Approved to use this Command DM:- @SHADOW_OFFICIAL11")
        return
...
async def user_info(message: Message):
    ...
    if user_data:
        ...
        approval_expiry_str = "𝙊𝙥𝙥𝙨 𝙉𝙤𝙩 𝙖𝙥𝙥𝙧𝙤𝙫𝙚𝙙 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 @SHADOW_OFFICIAL11"
